...
public class QnaController {
	...
	public ResponseEntity<QnaResultDto> boardList(QnaParameterDto qnaParameterDto){
		
		QnaResultDto qnaResultDto;
		System.out.println(qnaParameterDto.getSearchWord());
		System.out.println(qnaService);
		if( qnaParameterDto.getSearchWord().isEmpty() ) {
			qnaResultDto = qnaService.qnaList(qnaParameterDto);
		}else {
			qnaResultDto = qnaService.qnaListSearchWord(qnaParameterDto);
		}
		
//		if( qnaResultDto.getResult() == 1 ) {
